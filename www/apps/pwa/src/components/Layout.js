...
export default class Body extends React.Component {
  render() {
    let style =
      _.get(this.props, "pageContext.site.siteMetadata.style", null) ||
      "classic"
    let font =
    ...
    return (
      <ThemeProvider colorScheme="light">
        <Helmet>
          ...
          <body
            className={
              ...
              _.get(
                this.props,
                "pageContext.site.siteMetadata.layout_type",
                null
              ) +
              " style-" +
              _.get(this.props, "pageContext.site.siteMetadata.style", null) +
              ...
              " mode-" +
              _.get(this.props, "pageContext.site.siteMetadata.mode", null) +
              " font-" +
              _.get(this.props, "pageContext.site.siteMetadata.base_font", null)
            }
          />
        ...
        <div id="site-wrap" className="site">
          {_.get(
            this.props,
            "pageContext.site.siteMetadata.header.has_anncmnt",
            null
          ) &&
            _.get(
              this.props,
              "pageContext.site.siteMetadata.header.anncmnt_content",
              null
            ) &&
            (_.get(
              this.props,
              "pageContext.site.siteMetadata.header.anncmnt_is_home_only",
              null
            ) ? (
