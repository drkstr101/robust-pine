...
import { SectionHeader, CountUpNumber } from "@waweb/molecules"
          ...
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <SectionHeader
                ...
                subtitle="Watheia styles and extends Material-UI components, but also included brand new landing page focused components."
                align="left"
                fadeUp
                disableGutter
                titleVariant="h3"
