...
const Storage = ({ className, ...rest }: ViewComponentProps): JSX.Element => {
            ...
            <Section className={classes.section}>
              <>
                ...
                <SectionHeader
                  ...
                  subtitle={
                    <span className={classes.textWhite}>
                      Forward thinking businesses use our cloud backup service
                      to ensure data reliability and safety. Keep track of
                      what's happening with your data, change permissions, and
