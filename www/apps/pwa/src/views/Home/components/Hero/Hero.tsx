...
import { Section, DescriptionListIcon } from "@waweb/organisms"
...
const data = [
  {
    ...
    subtitle:
      "Watheia is built to make your life easier. Variables, build tooling, documentation, and reusable components.",
  },
  {
    icon: "fab fa-sketch",
    title: "Designed to be modern",
    subtitle:
      "Designed with the latest design trends in mind. Watheia feels modern, minimal, and beautiful.",
  },
  {
    icon: "fas fa-code",
