...
import { Section } from "@waweb/organisms"
...
const renderComponent = (): JSX.Element => {
  ...
  switch (componentId) {
    ...
    case "dark-mode-toggler":
      const DarkModeTogglerExample = lazy(
        () => import("./examples/DarkModeTogglerExample")
      )
    ...
    case "learn-more-link":
      const LearnMoreLinkExample = lazy(
        () => import("./examples/LearnMoreLinkExample")
      )
      Component = <LearnMoreLinkExample />
      break
    case "count-up-number":
      const CountUpNumberExample = lazy(
        () => import("./examples/CountUpNumberExample")
      )
      Component = <CountUpNumberExample />
      break
    case "description-with-cta":
      const DescriptionCtaExample = lazy(
        () => import("./examples/DescriptionCtaExample")
      )
      Component = <DescriptionCtaExample />
      break
    case "icon-alternate":
      const IconAlternateExample = lazy(
        () => import("./examples/IconAlternateExample")
      )
      Component = <IconAlternateExample />
      break
    case "overlapped-images":
      const OverlapedImagesExample = lazy(
        () => import("./examples/OverlapedImagesExample")
      )
      Component = <OverlapedImagesExample />
      break
    case "section-header":
      const SectionHeaderExample = lazy(
        () => import("./examples/SectionHeaderExample")
      )
      Component = <SectionHeaderExample />
      break
    case "image-swiper":
      const SwiperImageExample = lazy(
        () => import("./examples/SwiperImageExample")
      )
      Component = <SwiperImageExample />
      break
    case "numbers-swiper":
      const SwiperNumberExample = lazy(
        () => import("./examples/SwiperNumberExample")
      )
    ...
    case "card-base":
      ...
      break
    case "card-category":
      const CardCategoryExample = lazy(
        () => import("./examples/CardCategoryExample")
      )
      Component = <CardCategoryExample />
      break
    case "card-category-link":
      const CardCategoryLinkExample = lazy(
        () => import("./examples/CardCategoryLinkExample")
      )
    ...
    case "card-job-company":
      const CardJobCompanyExample = lazy(
        () => import("./examples/CardJobCompanyExample")
      )
      Component = <CardJobCompanyExample />
      break
    case "card-job-minimal":
      const CardJobMinimalExample = lazy(
        () => import("./examples/CardJobMinimalExample")
      )
      Component = <CardJobMinimalExample />
      break
    case "card-job-tag":
      const CardJobTagExample = lazy(
        () => import("./examples/CardJobTagExample")
      )
      Component = <CardJobTagExample />
      break
    case "card-pricing-standard":
      const CardPricingStandardExample = lazy(
        () => import("./examples/CardPricingStandardExample")
      )
      Component = <CardPricingStandardExample />
      break
    case "card-product":
      const CardProductExample = lazy(
        () => import("./examples/CardProductExample")
      )
    ...
    case "card-promo":
      ...
      break
    case "card-review":
      const CardReviewExample = lazy(
        () => import("./examples/CardReviewExample")
      )
      Component = <CardReviewExample />
      break
    case "description-list-icon":
      const DescriptionListIconExample = lazy(
        () => import("./examples/DescriptionListIconExample")
      )
      Component = <DescriptionListIconExample />
      break
    case "hero-background":
      const HeroBackgroundExample = lazy(
        () => import("./examples/HeroBackgroundExample")
      )
      Component = <HeroBackgroundExample />
      break
    case "hero-shaped":
      const HeroShapedExample = lazy(
        () => import("./examples/HeroShapedExample")
      )
      Component = <HeroShapedExample />
      break
    case "hero-side-image":
      const HeroSideImageExample = lazy(
        () => import("./examples/HeroSideImageExample")
      )
      Component = <HeroSideImageExample />
      break
    case "hero-simple-background":
      const HeroSimpleBackgroundExample = lazy(
        () => import("./examples/HeroSimpleBackgroundExample")
      )
    ...
    case "section-alternate":
      const SectionAlternateExample = lazy(
        () => import("./examples/SectionAlternateExample")
      )
