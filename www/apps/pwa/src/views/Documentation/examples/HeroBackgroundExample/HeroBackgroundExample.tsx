...
import { HeroBackground } from "@waweb/organisms"
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={6}>
            <Typography variant="h5" style={{ color: 'white' }} gutterBottom>
                Whether it’s Porsche, Stripe, Intercom, Amazon, or Google, something about Watheia works for our global partners.
            </Typography>
            <Typography variant="h5" style={{ color: 'white' }}>
                Want more information? Download our overview and a member of our specialist team will be in touch to talk about your goals for Watheia 2020.
            </Typography>
          </Grid>
          <Grid item xs={12} md={6}>
...
const HeroBackgroundExample = ({ ...rest }: any): JSX.Element => (
  <div {...rest}>
            ...
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} md={6}>
                ...
                >
                  ...
                  something about Watheia works for our global partners.
                </Typography>
                <Typography variant="h5" style={{ color: "white" }}>
                  Want more information? Download our overview and a member of
                  our specialist team will be in touch to talk about your goals
                  for Watheia 2020.
                </Typography>
              </Grid>
              <Grid item xs={12} md={6}>
