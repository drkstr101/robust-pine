...
import { HeroSimpleBackground } from "@waweb/organisms"
      ...
      <HeroSimpleBackground backgroundImage="https://assets.maccarianagency.com/the-front/shapes/banner-bg.svg">
        <Section narrow>
          <SectionHeader
            ...
            ctaGroup={[(
              <Button color="primary" variant="contained" size="large">Get support</Button>
            ), (
              <Button color="primary" variant="outlined" size="large">See demos</Button>
            )]}
          />
        </Section>
...
const HeroSimpleBackgroundExample = ({ ...rest }: any): JSX.Element => (
  <div {...rest}>
