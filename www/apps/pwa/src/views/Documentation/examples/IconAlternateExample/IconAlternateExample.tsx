...
import { IconAlternate } from "@waweb/molecules"
...
const dataProperties = [
  ...
  },
  {
    ...
    default: "",
    description:
      "Color of the icon. One of: colors.red, colors.pink, colors.purple, colors.deepPurple, colors.indigo, colors.blue, colors.lightBlue, colors.cyan, colors.teal, colors.green, colors.lightGreen, colors.lime, colors.yellow, colors.amber, colors.orange, colors.deepOrange, colors.brown, colors.grey, colors.blueGrey",
  },
  {
    name: "iconProps",
    type: "object",
...
const IconAlternateExample = ({ ...rest }: any): JSX.Element => (
  <div {...rest}>
