...
import { HeroSideImage } from "@waweb/organisms"
...
const HeroSideImageExample = ({ ...rest }: any): JSX.Element => (
  <div {...rest}>
        ...
        >
          <HeroSideImage imageSrc="https://assets.maccarianagency.com/the-front/photos/expo-gallery/gallery1.jpg">
            <Grid container spacing={4}>
              ...
              <Grid item xs={12}>
                <Typography variant="h6">
                  Download our overview and a member of our specialist team will
                  be in touch.
                </Typography>
              </Grid>
            </Grid>
