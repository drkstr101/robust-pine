...
const dataProperties = [
  ...
  },
  {
    ...
    default: "",
    description:
      "Header content (title, subtitle, CTAs) alignment. One of: right, left, center",
  },
  {
    name: "className",
    type: "string",
  ...
  },
  {
    ...
    default: "",
    description:
      "SubTitle color. One of: textPrimary, textSecondary, primary, secondary",
  },
  {
    name: "subtitleProps",
    type: "object",
  ...
  },
  {
    ...
    default: "",
    description:
      "SubTitle variant. One of: h1, h2, h3, h4, h5, h6, subtitle1, subtitle2, body1, body2",
  },
  {
    name: "titleClasses",
    type: "string",
...
export default function Example() {
  return (
    <Box marginBottom={2} display="flex" justifyContent="space-evenly" alignItems="center" padding={2} border="1px solid #ccc" borderRadius="4px">
      <SectionHeader
        title={<>Find a job you love.<a href="https://watheia.app/"> Learn more</a></>}
        subtitle={<>Try it now.<a href="https://watheia.app/"> Learn more</a></>}
        ctaGroup={[(
            <Button color="primary" variant="contained">Submit</Button>
        ), (
            <Button color="primary" variant="outlined">Learn More</Button>
...
const SectionHeaderExample = ({ ...rest }: any): JSX.Element => (
  <div {...rest}>
        ...
        >
          <SectionHeader
            title={
              <>
                Find a job you love.
                <a href="https://watheia.app/"> Learn more</a>
              </>
            }
            subtitle={
              <>
