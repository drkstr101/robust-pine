...
import { Parallax } from "@waweb/organisms"
          ...
          <CardBase withShadow style={{ width: 500, height: 'auto', background: 'transparent' }}>
            <SectionHeader
              ...
              subtitle={<span style={{ color: 'white' }}>
                Watheia styles and extends Material UI components, but also included brand new landing page focused components.
              </span>}
            />
          </CardBase>
        </div>
...
const ParallaxExample = ({ ...rest }: any): JSX.Element => (
  <div {...rest}>
            ...
            >
              ...
              >
                <SectionHeader
                  ...
                  subtitle={
                    <span style={{ color: "white" }}>
                      Watheia styles and extends Material UI components, but
                      also included brand new landing page focused components.
                    </span>
                  }
                />
              </CardBase>
