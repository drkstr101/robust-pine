...
export const advantages = [
  {
    ...
    subtitle:
      "We bring over 2,500 journalists from the world’s leading publications to Watheia. They’re part of the reason why the event has a global reach of over three billion. We can also work with you on bespoke content packages that will tell your story on a global scale.",
  },
  {
    icon: "fas fa-brain",
